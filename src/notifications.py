...
class ProcesarDetecciones:
    ...
    #             cap.set(cv2.CAP_PROP_POS_FRAMES, 0)  # Reiniciar video desde el inicio
    #             continue  # Saltar a la siguiente iteración para leer el siguiente frame
